                                               ...
                                               <div id="table-wrapper">
                                                   ...
                                                   <div id="table-body" class="ant-row">
                                                      <div class="ant-row">
                                                       ...
                                                       @for($i=0;$i<$n ; $i++)
                                                           <?php
                                                               $id = $base_price_factor[$i]['id'];
                                                                $insurance = \App\ThirdPartyInsurance::findOrFail($id)->insuranceCompany;
                                                                if (isset($base_price_factor[$i]['application'])){
                                                                    $application = $base_price_factor[$i]['application']/100;
                                                                }else{
                                                                    $application = 0;
                                                                }
                                                           ?>
                                                       {{--./shurue box namyesh--}}
                                                        ...
                                                        <div id="tariff_text0" class="ant-col-xs-24 ant-col-sm-15 ant-col-md-15 ant-col-lg-14">
                                                            <div class="progress-result progressPrice">
                                                                ...
                                                                <span class="maxtariff"><span>بیشترین قیمت</span></span><span class="mintariff"><span>کمترین قیمت</span></span><span class="show showprice"><span class="">{{number_format($base_price_factor[$i]['base']*($darsad+$application) ,0,'/',',')}}</span><sum> تومان</sum></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="slideUpDow" onclick="myFunction{{$i+1}}()">اطلاعات بیشتر</div>
                                                            ...
                                                            <div class="ant-col-xs-24 ant-col-sm-12 fa_number">مبلغ پایه بیمه
                                                                :{{number_format($base_price_factor[$i]['base']*($darsad+$application) ,0,'/',',')}}
                                                            </div>
