                ...
                @if($categories)
                    ...
                    @foreach($categories as $categor)
                        ...
                        <tr class={{$table_class}}>
                            ...
                            <td class="center"><a href="{{route('posts.edit',['id'=>$categor->id])}}"><i class="fa fa-edit green fa-2x" aria-hidden="true"></i></a></td>


                            {!! Form::open(['method'=>'DELETE','action'=>['AdminPostsController@destroy','id'=>$categor->id]]) !!}
